...
I decided to join the data analytics world since I believe data-driven decisions should be employed in and out a working environment, in order to limit uncertainty in decision making. I began this journey a couple of years ago, exploiting free online sources to learn some technical tools and soon I'm going to end a Master degree which provide precious inisghts and a useful academic knowledge in the sector of D.S. (with applications in Economics).
